...
import img0 from "../../assets/sia/Filtration/filtre a air/filtre-a-air-106-205-partner-1 réf BA2248.jpg";
import img1 from "../../assets/sia/Filtration/filtre a air/filtre-a-air-nemo-14-hdi réf  BA2210.jpg";
import img2 from "../../assets/sia/Filtration/filtre a air/filtrea-air-grande-punto réf BA2181.jpg";
const products = [
  { id: 1, name: "filtre-a-air-106-205-partner-1 réf BA2248", image: img0, reference: "REF-"+0, pscCarton: 1, size: "N/A", tag: "Piece" },
  { id: 2, name: "filtre-a-air-nemo-14-hdi réf  BA2210", image: img1, reference: "REF-"+1, pscCarton: 1, size: "N/A", tag: "Piece" },
  { id: 3, name: "filtrea-air-grande-punto réf BA2181", image: img2, reference: "REF-"+2, pscCarton: 1, size: "N/A", tag: "Piece" },
];
...
const Breadcrumb = () => (
  <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
    ...
    <span className="text-gray-400 text-base"> &gt; </span>
    <span className="text-[#c0141c] font-semibold">Filtre a air</span>
  </nav>
);
...
export default function filtreaairPage() {
