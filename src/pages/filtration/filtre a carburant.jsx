...
const products = [
  {
    id: 1,
    name: "carter-filtre",
    reference: " 1K0127434B ORI",
    image :"/sia/Filtration/filtre a carburant/carter-filtre réf  1K0127434B ORI.jpg",
    tag: "Filtre a carburant",
  },
  {
    id: 2,
    name: "filcarbpeug-citroen20hdi ",
    reference: " 4265",
    image :"/sia/Filtration/filtre a carburant/filcarbpeug-citroen20hdi réf 4265.jpg",
    tag: "Filtre a carburant",
  },
  {
    id: 3,
    name: "filtre-a-gasoil-volkswagen-golf-polo-transporter ",
    reference: " 4113-M",
    image :"/sia/Filtration/filtre a carburant/filtre-a-gasoil-volkswagen-golf-polo-transporter réf 4113-M.jpg",
    tag: "Filtre a carburant",
  },
];
...
const filterSousDivision2 = ["Filtre a air", "Filtre a carburant", "Filtre a huile  ","Filtre habitacle" ];
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadLink}>Filtration</span>
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>Filtre a carburant  </span>
  </nav>
);
