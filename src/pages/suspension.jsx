...
import imgCat0 from "../assets/suspen/roule.png";
import imgCat1 from "../assets/suspen/embray.png";
import imgCat2 from "../assets/suspen/jantes.png";
import imgCat3 from "../assets/suspen/triang.png";

const categories = [
  { id: 1, title: "boulements", image: imgCat0, link: "/divisions/piece-de-rechange/suspension/boulements" },
  { id: 2, title: "Embrayage", image: imgCat1, link: "/divisions/piece-de-rechange/suspension/embrayage" },
  { id: 3, title: "jante roue", image: imgCat2, link: "/divisions/piece-de-rechange/suspension/jante-roue" },
  { id: 4, title: "Triangles", image: imgCat3, link: "/divisions/piece-de-rechange/suspension/triangles" },
];
      ...
      <div className="w-full bg-[#f8f8f8] border-b border-gray-200 mb-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
            ...
            <span className="text-gray-400 text-base"> &gt; </span>
            <span className="text-[#c0141c] font-semibold">Suspension / Direction</span>
          </nav>
        </div>
      </div>
