...
import img0 from "../../assets/sia/Suspension Direction/Embrayage/kit-d-embrayage-partner-expert-3-16-hdi-08 ref 1611269280.jpg";
...
const Breadcrumb = () => (
  <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
    ...
    <span className="text-gray-400 text-base"> &gt; </span>
    <span className="text-[#c0141c] font-semibold">Embrayage</span>
  </nav>
);
...
export default function EmbrayagePage() {
