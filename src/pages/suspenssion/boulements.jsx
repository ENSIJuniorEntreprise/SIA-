...
import img0 from "../../assets/sia/Suspension Direction/boulements/rotule-de-direction-citroen-c5-nm ref 3817_95.jpg";
...
const Breadcrumb = () => (
  <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
    ...
    <span className="text-gray-400 text-base"> &gt; </span>
    <span className="text-[#c0141c] font-semibold">Boulements</span>
  </nav>
);
...
export default function boulementsPage() {
