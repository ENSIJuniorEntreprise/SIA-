...
const products = [
  {
    id: 1,
    name: "Disque-de-frein-golf-2 ",
    reference: "  A1011P",
    image :"/sia/Freinage/disques/disque-de-frein-golf-2 ref A1011P.jpg",
    tag: "Disques",
  },
  {
    id: 2,
    name: "disques-de-frein-av-escort-fiesta-89- ",
    reference: " F1111V",
    image :"/sia/Freinage/disques/disques-de-frein-av-escort-fiesta-89- ref F1111V.jpg",
    tag: "Disques",
  },
  {
    id: 2,
    name: "disques-frein-av-a494-97  ",
    reference: " A1491V",
    image :"/sia/Freinage/disques/disques-frein-av-a494-97 ref A1491V.jpg",
    tag: "Disques",
  },
];
...
const filterSousDivision2 = ["Disques", "étriers", "hydraulique  ","plaquettes" ,"ressort","rotules",];
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadLink}>Freinage</span>
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>Disques  </span>
  </nav>
);
