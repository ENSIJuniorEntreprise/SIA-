  ...
  return (
    <div style={styles.page}>
      ...
      h    src="ss1.jpg"
        ...
        <h1 style={styles.heroTitle1}>  MARINE</h1>
      </div>
      ...
      <div style={styles.breadcrumbBar}>
        ...
        <span style={styles.breadcrumbSep}>Division Marine</span>
        <span style={styles.breadcrumbSep}> &gt; </span>
        <span style={styles.breadcrumbActive}>Groupes électrogènes marin</span>
      </div>
