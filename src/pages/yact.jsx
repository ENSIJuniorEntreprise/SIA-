...
import im3 from "../assets/marine/grp elec/b peche.jpg";
import im4 from "../assets/marine/grp elec/tm.jpg";
import im5 from "../assets/marine/grp elec/yacht.jpg";
const products = [
  {
    id: 1,
    name: "peche",
...
"Yact", "bateau de peche", "travaux maritimes"
];
      ...
      <div className="w-full bg-[#f8f8f8] border-b border-gray-200 mb-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
              ...
              <a  onClick={() => navigate('/divisions/marine')} href="#" className="text-gray-600 hover:text-red-700 transition">Division Marine</a>
              <span className="text-gray-400 text-base"> &gt; </span>
              <a  href="#" className="text-gray-600 hover:text-red-700 transition"> Yact</a>
              <span className="text-gray-400 text-base"> &gt; </span>
            </nav>
