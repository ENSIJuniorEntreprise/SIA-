...
const products = [
  ...
  },
  {
    id: 2,
    name: "Groupe électrogène diesel",
    reference: "D8 MG HE KC",
    puissanceDesortie: "170 kW, 198 kW, 218 kW, 250 kW",
    fréquence: "50 Hz, 60 Hz",
    tension: "120V / 240V",
    image: "D8 MG HE KC.webp",
    tag: "Yact",
  },
  {
    id: 3,
    name: "Groupe électrogène diesel",
    reference: "4 GSCH v3",
    puissanceDesortie: "3 KVA",
    fréquence: "50 Hz",
    tension: "230V",
    image: "4 GSCH v3.webp",
    tag: "Yact",
  },
];
...
const filterSousDivision1 = [
  "Groupes électrogènes marin",
  "SAV & consommable",
];
const filterSousDivision2 = ["Yact", "bateau de peche", "travaux maritimes"];
  ...
  return (
    ...
    >
      ...
      <div style={styles.cardBody}>
        ...
        <div style={styles.cardMeta}>
          <span style={styles.metaLabel}>Puissance de sortie :</span>
          <span style={{ ...styles.metaVal, ...styles.sizeVal }}>
            {product.puissanceDesortie}
          </span>
        </div>
        <div style={styles.cardMeta}>
          <span style={styles.metaLabel}>Fréquence :</span>
          <span style={styles.metaVal}>{product.fréquence}</span>
        </div>
        <div style={styles.cardMeta}>
          <span style={styles.metaLabel}>Tension :</span>
          <span style={styles.metaVal}>{product.tension}</span>
        </div>
      </div>
      <button
        style={{
      ...
      <div style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>
            Division&nbsp;<span style={styles.heroTitleAccent}>Marine</span>
          </h1>
        </div>
      </div>
