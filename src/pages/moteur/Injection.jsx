...
const products = [
  {
    id: 1,
    name: "injecteur aveo classique ",
    reference: " 96800843L",
    image: "/sia/MOTEUR/Injection carburant/injecteur aveo classique réf 96800843L.jpg",
    tag: "injection",
  },
  {
    id: 3,
    name: "injecteur essence ",
    reference: "IPM002 MAGN",
    image: "/sia/MOTEUR/Injection carburant/injecteur essence réf  IPM002 MAGN.jpg",
    tag: "injection",
  },
  {
    id: 3,
    name: "Nez injecteur bosch pour RENAULT ",
    reference: " 96800843L",
    image: "/sia/MOTEUR/Injection carburant/Nez injecteur BOSCH pour RENAULT, référence DLLA150P326..jpg",
    tag: "injection",
  },
];
...
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>Injection/Carburant</span>
  </nav>
);
