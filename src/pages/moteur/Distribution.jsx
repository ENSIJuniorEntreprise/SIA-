...
const products = [
  {
    id: 1,
    name: "courroie-distribution-127dents-chevrolet ",
    reference: " 1987949403",
    image: "/sia/MOTEUR/Distribution/courroie-distribution-127dents-chevrolet réf 1987949403.jpg",
    tag: "Distribution",
  },
  {
    id: 3,
    name: "courroie-distribution-141d    ",
    reference: "1987949188",
    image: "/sia/MOTEUR/Distribution/courroie-distribution-141d réf 1987949188.jpg",
    tag: "Distribution",
  },
  {
    id: 3,
    name: "kit-de-distribution-130d58d-volkswagen-14  ",
    reference: " 1987949190",
    image: "/sia/MOTEUR/Distribution/kit-de-distribution-130d58d-volkswagen-14 réf 1987949190.jpg",
    tag: "Distribution",
  },
];
...
const filterSousDivision2 = ["Lubrification", "Pistons", "Courroies", "Échappement",'injection','culasse','Démarrage','Distribution',"Admission et échappement","Embrayage","Refroidissment" ];
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>Distribution</span>
  </nav>
);
