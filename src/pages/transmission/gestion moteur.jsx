...
const products = [
  { id: 1, name: "support-moteur-406-95-04 ref 4006", image: img0, reference: "REF-0", pscCarton: 1, size: "N/A", tag: "Piece" },
  { id: 2, name: "support-moteur-av-berl-part-16hdi ref 2700025", image: img1, reference: "REF-1", pscCarton: 1, size: "N/A", tag: "Piece" },
  { id: 3, name: "support-moteur-partner-tepee ref 2700038", image: img2, reference: "REF-2", pscCarton: 1, size: "N/A", tag: "Piece" },
];
...
const Breadcrumb = () => (
  <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
    ...
    <span className="text-gray-400 text-base"> &gt; </span>
    <span className="text-[#c0141c] font-semibold">Gestion moteur</span>
  </nav>
);
