...
import img0 from "../../assets/sia/Transmission/cardans/cardan-droit-boxer-nm-hdi-120cv ref T29170.jpg";
...
const Breadcrumb = () => (
  <nav className="flex flex-wrap items-center gap-2 py-4 text-sm text-gray-500">
    ...
    <span className="text-gray-400 text-base"> &gt; </span>
    <span className="text-[#c0141c] font-semibold">Cardans</span>
  </nav>
);
...
export default function cardansPage() {
