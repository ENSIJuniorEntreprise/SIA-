...
const products = [
  {
    id: 1,
    name: "mano-de-huile-mazda-hyundai-suzuki-mitsubishi",
    reference: "  330009",
    image :"/sia/EléctricitéÉlectronique/capteurs/mano-de-huile-mazda-hyundai-suzuki-mitsubishi ref 330009.jpg",
    tag: "capteurs",
  },
  {
    id: 2,
    name: "mano de temperature opel   ",
    reference: " 330117",
    image :"/sia/EléctricitéÉlectronique/capteurs/mano-de-temperature-opel- ref 330117.jpg",
    tag: "capteurs",
  },
  {
    id: 3,
    name: "mano de temperature renault et nissan   ",
    reference: " 330692",
    image :"/sia/EléctricitéÉlectronique/capteurs/mano-de-temperature-renault-et-nissan ref 330692.jpg",
    tag: "capteurs",
  },
];
...
const filterSousDivision2 = ["capteurs", "charge", "gestion moteur", "habitacle " ];
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadLink}>EléctricitéÉlectronique</span>
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>capteurs</span>
  </nav>
);
