...
const products = [
  {
    id: 1,
    name: "capteur-de-vilebrequin-polo",
    reference: "  550221A",
    image :"/sia/EléctricitéÉlectronique/charge/capteur-de-vilebrequin-polo ref550221A.jpg",
    tag: "charge",
  },
  {
    id: 2,
    name: "mano-temperature-citroen-cx-  ",
    reference: " 330171",
    image :"/sia/EléctricitéÉlectronique/charge/mano-temperature-citroen-cx- ref 330171.jpg",
    tag: "charge",
  },
  {
    id: 3,
    name: "mano-temperature-peugeot-205-309 ",
    reference: " 330167",
    image :"/sia/EléctricitéÉlectronique/charge/mano-temperature-peugeot-205-309 ref 330167.jpg",
    tag: "charge",
  },
];
...
const Breadcrumb = () => (
  <nav style={styles.breadcrumb}>
    ...
    <span style={styles.breadSep}> &gt; </span>
    <span style={styles.breadActive}>charge</span>
  </nav>
);
